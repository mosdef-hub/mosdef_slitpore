...
def md_files(job):
    ...
    with job:
        ...
        q=MD(molecules=[molecule],box=box,cutoff=650,functional='BLYP',basis_set={'C':'DZVP-MOLOPT-SR-GTH','H':'DZVP-MOLOPT-SR-GTH','O':'DZVP-MOLOPT-SR-GTH'},periodicity='XYZ',n_molecules=[1],traj_type='PDB',seed=1,project_name='carbon_water',initial_coordinate_filename='init.mol2',fixed_list='1..80')
