...
server_run_directory = 'Simulations/Graphene_water/Graphene_water_MoSDeF/mosdef_slitpore/simulations/adsorption/3x3x1.0nm_3-layer/gomc/set1'  #set if if you want to build locally and run on server
job_name='wp_10'
