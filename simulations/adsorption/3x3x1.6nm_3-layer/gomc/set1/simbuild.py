...
server_run_directory = 'Simulations/Graphene_water/Graphene_water_MoSDeF/mosdef_slitpore/simulations/adsorption/3x3x1.6nm_3-layer/gomc/set1' #set if if you want to build locally and run on server
job_name='wp_16'
...
mus1 = [-5212, -4852, -4491, -4130, -4085, -4040, -3950, -3769]
mus2 = [    -10000000, -2500, -1800, -1500, -1500, -1500, -1500, -1000 ]
