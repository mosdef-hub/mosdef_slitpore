...
for irun in range(0, nruns):
    ...
    if restart[irun] == 0:
        ...
        if adsorption_or_desorption == 'ads' :
	        pdb_name = ['../../build_ads_system/pore_3x3x1.6nm_3-layer.pdb', '../../build_ads_system/GOMC_reservior_fake_water_box.pdb']
	        psf_name = ['../../build_ads_system/pore_3x3x1.6nm_3-layer.psf', '../../build_ads_system/GOMC_reservior_fake_water_box.psf']
        elif adsorption_or_desorption == 'des':
	        pdb_name = ['../../NVT/3x3x1.6nm_3-layer/Output_data_BOX_0_restart.pdb', '../../NVT/3x3x1.6nm_3-layer/NVT_build/GOMC_reservior_fake_water_box.pdb']
	        psf_name = ['../../NVT/3x3x1.6nm_3-layer/Output_data_merged.psf',        '../../NVT/3x3x1.6nm_3-layer/NVT_build/GOMC_reservior_fake_water_box.psf']
        else:
