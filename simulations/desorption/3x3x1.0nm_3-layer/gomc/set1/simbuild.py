...
prog = '/wsu/home/hf/hf68/hf6839/GOMC-2_6-master/bin/GOMC_CPU_GCMC'   #location where GOMC file is kept
#prog = '/home/brad/Programs/GOMC/GOMC-2_6-master/bin/GOMC_CPU_GCMC'
server_run_directory = 'Simulations/Graphene_water/Graphene_water_MoSDeF/mosdef_slitpore/simulations/desorption/3x3x1.0nm_3-layer/gomc/set1'  #set if if you want to build locally and run on server
job_name='wp_10'
