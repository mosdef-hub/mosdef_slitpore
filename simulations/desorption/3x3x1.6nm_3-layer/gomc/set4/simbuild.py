...
server_run_directory = 'Simulations/Graphene_water/Graphene_water_MoSDeF/mosdef_slitpore/simulations/desorption/3x3x1.6nm_3-layer/gomc/set4'
job_name='wp_16'
...
mus2 = [    -10000000,    -10000000,    -10000000, -2200,  -2100, -2000, -1800, -1500] # [    -10000000,    -10000000,    -10000000, -2200,  (-2500 =~1.5,  -2300~2.7), (-2300 =~1.5. -2000 ~4.3), (-2100 =~1.5, -1800~4.3), (-1800 =~1.5, -1500~3.8) ]
...
for irun in range(0, nruns):
    ...
    if restart[irun] == 0:
        ...
        if adsorption_or_desorption == 'ads' :
	        pdb_name = ['../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/pore_3x3x1.6nm_3-layer.pdb', '../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/GOMC_reservior_fake_water_box.pdb']
	        psf_name = ['../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/pore_3x3x1.6nm_3-layer.psf', '../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/GOMC_reservior_fake_water_box.psf']
        elif adsorption_or_desorption == 'des':
	        pdb_name = ['../../../../../NVT/3x3x1.6nm_3-layer/gomc/Output_data_BOX_0_restart.pdb', '../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/GOMC_reservior_fake_water_box.pdb']
	        psf_name = ['../../../../../NVT/3x3x1.6nm_3-layer/gomc/Output_data_merged.psf',        '../../../../../gomc_pdb_psf_FF/Grapene_Water_builder/GOMC_reservior_fake_water_box.psf']
        else:
