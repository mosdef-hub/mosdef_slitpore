...
residues_Graphene_pore_w_solvent_fake_water_List = [Fake_water.name, water.name,  'BOT', 'TOP','GraphenePore']
...
mf_charmm.charmm_psf_psb_FF(filled_pore,
                  'filled_pore_fake_water_3x3x1.0nm_3-layer',
                  structure_1 =None ,
                  filename_1 = None,
