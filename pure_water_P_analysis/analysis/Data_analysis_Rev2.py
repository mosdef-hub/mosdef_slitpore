...
ratio_of_Psat_ratio = [0.005, 0.01, 0.05, 0.1, 0.25, 0.5, 1.0, 2.0, 3.0]
ratio_of_Psat = ['r_0_005', 'r_0_01', 'r_0_05','r_0_1', 'r_0_25', 'r_0_5', 'r_1_0', 'r_2_0', 'r_3_0']
Fugacity = [0.000157526835982985, 0.000315053671966, 0.00157526835982985, 0.0031505367196597,0.00787634179914925 ,0.0157526835982985, 0.031505367196597, 0.063010734393194, 0.094516101589791]
Volume_box_Ang_cubed = [60**3, 60**3, 60**3, 60**3, 60**3, 60**3, 60**3, 60**3, 60**3]
...
if Use_Antoine_Eqn==1:
	...
	Antoine_Coeff_dataframe.to_csv(Antoine_coeff_save_file_name + "_df.txt", sep="	", header=['Fugacity_bar', 'P_bar'])
# ***********************
...
for j in range(len(ratio_of_Psat)):
	...
	Column_Fugacity_Title = 'Fugacity_bar'  # column title Title for PRESSURE
...
Box_0_data_dataframe =pd.DataFrame(np.column_stack([ratio_of_Psat_ratio , Fugacity_List, Pressure_Box_0_List,
													P_from_IG_Density_Box_0_List ,
...
Box_0_data_dataframe.to_csv(Box_data_save_file_name + '0_'+str(Chemical_being_analyzed)+'_df.txt', sep="	",
							header=[Column_Psat_ratio_Title, Column_Fugacity_Title, Column_no_Pressure_Title,
