...
def plot_large_2nm():
    ...
    gomc_path = "gomc/analysis/"
    ow_gomc = pd.read_csv(data_path+gomc_path+"Average_No_Density_data_ow.csv", index_col=0)
    hw_gomc = pd.read_csv(data_path+gomc_path+"Average_No_Density_data_hw.csv", index_col=0)
    s_gomc = pd.read_csv(data_path+gomc_path+"Average_order_param_data.csv", index_col=0)
