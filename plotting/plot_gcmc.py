...
def plot_ads_des_data():
    ...
    gubbins_data_path = "../simulations/Plot_ads_des/"
    calc_data_reading_name_10A_ads_Gubbins = gubbins_data_path + 'Gubbins_extracted_data/10_ads_rescaled.csv'
    calc_data_reading_name_16A_ads_Gubbins = gubbins_data_path + 'Gubbins_extracted_data/16_ads_rescaled.csv'
    
    calc_data_reading_name_10A_des_Gubbins = gubbins_data_path + 'Gubbins_extracted_data/10_des_rescaled.csv'
    calc_data_reading_name_16A_des_Gubbins = gubbins_data_path + 'Gubbins_extracted_data/16_des_rescaled.csv'
    ...
    calc_data_reading_name_10A_ads = '../simulations/adsorption/3x3x1.0nm_3-layer/gomc/analysis/adsorption_10A_slit_df.txt'
    calc_data_reading_name_16A_ads = '../simulations/adsorption/3x3x1.6nm_3-layer/gomc/analysis/adsorption_16A_slit_df.txt'
    
    calc_data_reading_name_10A_des = '../simulations/desorption/3x3x1.0nm_3-layer/gomc/analysis/desorption_10A_slit_df.txt'
    calc_data_reading_name_16A_des = '../simulations/desorption/3x3x1.6nm_3-layer/gomc/analysis/desorption_16A_slit_df.txt'
    ...
    calc_data_reading_name_10A_ads_Cass = '../simulations/adsorption/3x3x1.0nm_3-layer/cassandra/analysis/results.csv'
    calc_data_reading_name_16A_ads_Cass = '../simulations/adsorption/3x3x1.6nm_3-layer/cassandra/analysis/results.csv'
    
    calc_data_reading_name_10A_des_Cass = '../simulations/desorption/3x3x1.0nm_3-layer/cassandra/analysis/results.csv'
    calc_data_reading_name_16A_des_Cass = '../simulations/desorption/3x3x1.6nm_3-layer/cassandra/analysis/results.csv'
    
    calc_reading_name_pressure_Cass = '../simulations/bulk-water/cassandra/analysis/results.csv'
